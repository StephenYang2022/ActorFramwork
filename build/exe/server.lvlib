...
<Library LVVersion="16008000">
	...
	<Item Name="Messages for this Actor" Type="Folder">
		<Item Name="send message to server Msg.lvclass" Type="LVClass" URL="../Application.exe/server/server Messages/send message to server Msg/send message to server Msg.lvclass"/>
	</Item>
	<Item Name="server.lvclass" Type="LVClass" URL="../Application.exe/server/server/server.lvclass"/>
</Library>
